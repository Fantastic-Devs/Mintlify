...
graph TB;
    A["🙋<br>&nbsp;&nbsp;UserID: ACT123456&nbsp;&nbsp;&nbsp;"];
    B["✍<br>Document Verification"];
    C["❤️<br>&nbsp;&nbsp;&nbsp;&nbspLiveness Check&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"];
    D["💰<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AML Screening&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"];
    E["✔️ Approved"];
    F["❌ Declined"];
    ...
    D --> F;
    %% Classes
    classDef largeText font-size:20px, text-align:center;
    class A,B,C,D largeText;

    style E fill:#d5e8d4,stroke:#82b366,stroke-width:2px, width:200px, display:block, margin:auto;
    style F fill:#f8cecc,stroke:#b85450,stroke-width:2px, width:200px, display:block, margin:auto;

...
# **ACT-GEOSAFE - Android SDK**

## **Overview**
**ACTGeoSDK** is an Android SDK designed for compliance purposes. This SDK ensures that the end user's location complies with regulatory requirements by performing checks and providing the necessary feedback to your application.

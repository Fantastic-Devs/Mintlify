...
## Lookup Reponses 
<table>
  <tr><td><img src="images/success.png" /></td><td><ul><li><b>Inside location</b><br />This is returned if the device requests a location from within the designated jurisdiction</li></ul></td></tr></table>

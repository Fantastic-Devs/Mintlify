...
<ul>
  <li>**Date & Time**<br> 
Date and Time the Lookup occurred</li> 
...
Unique Lookup ID </li>
  ...
  <li>**Latitude & Longitude**<br>  
Location details </li>
 

  <li>**Reason For Fail**<br>  
Only available if the Lookup is either unsuccessful or outside.  This displays the reason that the lookup failed. </li>
 

  <li>**Reason For Lookup**<br>  
This displays the reason that the Lookup occurred (for example customer was logging in or customer was placing a wager) </li>
</ul>
